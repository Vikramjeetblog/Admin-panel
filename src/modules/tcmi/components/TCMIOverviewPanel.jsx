...
import TCMIAcademicModules from "./TCMIAcademicModules";
  ...
  return (
    <section className="rounded-lg border border-[var(--tcmi-border)] bg-white p-3 lg:p-4">
      ...
      <TCMIAcademicModules
        ...
        batchRows={batchRows}
        openBatchEditDialog={openBatchEditDialog}
        requestDelete={requestDelete}
        openAttendanceDialog={openAttendanceDialog}
        attendanceRows={attendanceRows}
        openAttendanceEditDialog={openAttendanceEditDialog}
        attendanceByBatch={attendanceByBatch}
        attendanceByStudent={attendanceByStudent}
        openExamModuleDialog={openExamModuleDialog}
        examRows={examRows}
        openExamEditDialog={openExamEditDialog}
        openDocumentDialog={openDocumentDialog}
        documentRows={documentRows}
        openDocumentEditDialog={openDocumentEditDialog}
      />
